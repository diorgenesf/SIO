 ...
 */
public class JDialogProdutoEdicaodeDados extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPesquisa
     */
    public JDialogProdutoEdicaodeDados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Produto.carregaTabela(jTableProdutos);
    }
    public JDialogProdutoEdicaodeDados(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Produto.carregaTabela(jTableProdutos);
    }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        // TODO add your handling code here:
        String S = ""+jTableProdutos.getValueAt(jTableProdutos.getSelectedRow(), 0);
        new JDialogProdutoExcluir(this, true, Integer.parseInt(S)).setVisible(true);
        Produto.carregaTabela(jTableProdutos);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        // TODO add your handling code here:
        String S = ""+jTableProdutos.getValueAt(jTableProdutos.getSelectedRow(), 0);
        new JDialogProdutoAlterar(this, true, Integer.parseInt(S)).setVisible(true);
        Produto.carregaTabela(jTableProdutos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogProdutoEdicaodeDados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogProdutoEdicaodeDados dialog = new JDialogProdutoEdicaodeDados(new javax.swing.JFrame(), true);
